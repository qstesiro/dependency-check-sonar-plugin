...
public final class DependencyCheckMetrics implements Metrics {
    ...
    private static final String HMM_DEMO_KEY = "hmm_demo";
    ...
    public static final Metric<Double> VULNERABLE_COMPONENT_RATIO = new Metric.Builder(
        DependencyCheckMetrics.VULNERABLE_COMPONENT_RATIO_KEY,
    ...
    public static final Metric<String> REPORT = new Metric.Builder(
        REPORT_KEY,
    ...
    public static final Metric<String> HMM_DEMO = new Metric.Builder(
        HMM_DEMO_KEY,
        "Hmm Demo",
        Metric.ValueType.STRING
    ).setDescription("Dependency-Check hmm demo")
        .setQualitative(Boolean.FALSE)
        .setDomain(DependencyCheckMetrics.DOMAIN)
        .setHidden(false)
        .create();
    ...
    public List<Metric> getMetrics() {
        return Arrays.asList(
            ...
            DependencyCheckMetrics.HMM_DEMO // ???
        );
    }
}
